...
public class Methods {
			...
			String address, String city,String state,String zip ,String phone,String filepath)
	{
		...
		try {
			FileWriter     fw = new FileWriter(filepath,true);  //does not overides but appends,writes when there is any value
	...
	public void removeRecord( String name) throws FileNotFoundException {
		...
		String tempFile = "C:/Users/PRATEEK/Desktop/Test/temp.txt";
		File oldFile = new File("C:/Users/PRATEEK/Desktop/Test/output.txt");
		...
		try {
			...
			BufferedWriter bw = new BufferedWriter(fw);
			PrintWriter    pw = new PrintWriter(bw);
			Scanner sc = new Scanner(new File( "C:/Users/PRATEEK/Desktop/Test/output.txt"));
			sc.useDelimiter("[,\n]");
			...
			pw.close();
			oldFile.delete();
			File dump = new File("C:/Users/PRATEEK/Desktop/Test/output.txt");
